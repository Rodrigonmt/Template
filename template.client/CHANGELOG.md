...
- Crie um projeto angular com ng: `ng new "template.client" --defaults --skip-install --skip-git --no-standalone `.
...
- Atualize o componente app.ts para buscar e exibir informações meteorológicas.
- Modifique app.spec.ts com testes atualizados.
- Atualize app-module.ts para importar o HttpClientModule.
- Criar o arquivo de projeto (`template.client.esproj`).
